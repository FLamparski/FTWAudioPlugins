...
def main():
  ...
  plistpath = scriptpath + "/resources/WeirdOrgan-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WeirdOrgan-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/WeirdOrgan-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/WeirdOrgan-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/WeirdOrgan-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/WeirdOrgan.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/WeirdOrgan.iss",inplace=1):
