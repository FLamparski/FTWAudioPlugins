...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=WeirdOrgan Demo Installer\n"
      else:
        line="OutputBaseFilename=WeirdOrgan Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the WeirdOrgan Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the WeirdOrgan installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=WeirdOrgan Demo installer\n"
     else:
       line="SetupWindowTitle=WeirdOrgan installer\n"
